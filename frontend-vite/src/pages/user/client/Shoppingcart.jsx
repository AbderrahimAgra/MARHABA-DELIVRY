...
import { selectCart, setItemQuantity } from "../../../store/slices/cart.sclice";
          ...
          <div className="flex shadow-md my-10">
            <div className="bg-white w-3/4 px-10 py-10">
              ...
              {cart.length === 0 ? 
                ...
                <svg  onClick={() => dispatch(setItemQuantity({_id: item._id,quantity: item.quantity >0 ? item.quantity -1:item.quantity}))} className="fill-current text-gray-600 w-3" viewBox="0 0 448 512"><path d="M416 208H32c-17.67 0-32 14.33-32 32v32c0 17.67 14.33 32 32 32h384c17.67 0 32-14.33 32-32v-32c0-17.67-14.33-32-32-32z"/>
                </svg>
          
                  <input className="mx-2 border text-center w-8 " type="text" value={item.quantity} readOnly min={0}/>
                  <svg onClick={() => dispatch(setItemQuantity({_id: item._id,quantity: item.quantity +1}))} className="fill-current text-gray-600 w-3" viewBox="0 0 448 512">
                    <path d="M416 208H272V64c0-17.67-14.33-32-32-32h-32c-17.67 0-32 14.33-32 32v144H32c-17.67 0-32 14.33-32 32v32c0 17.67 14.33 32 32 32h144v144c0 17.67 14.33 32 32 32h32c17.67 0 32-14.33 32-32V304h144c17.67 0 32-14.33 32-32v-32c0-17.67-14.33-32-32-32z"/>
                  </svg> 
                </div>
                <div className="flex justify-between items-center w-1/6">
                  <span className=""> {item.price}$</span>
                  <img className="w-6" src="../../../public/assets/delete-cart .png" />
                </div>  
              </div>))}
